...
<?php the_content();?>
        <div class="home-hero">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4  d-none d-xl-block hidden-lg-down">
                        <div class="contain-form-container pt-3">
        ...
        <div class="home-hero__text  home-hero__text--mobile  d-lg-none">
        ...
        <div class="container-fluid  d-xl-none  home-get-quote">
            <div class="row">
